...
public enum MhsBandInfo implements BandInfo {
    RADIANCE01("radiance_1", ProductData.TYPE_INT32, SCENE_RADIANCE_SCALING_FACTOR, new RadianceReader("SCENE_RADIANCES", 0)),
    RADIANCE02("radiance_2", ProductData.TYPE_INT32, SCENE_RADIANCE_SCALING_FACTOR, new RadianceReader("SCENE_RADIANCES", 1)),
    RADIANCE03("radiance_3", ProductData.TYPE_INT32, SCENE_RADIANCE_SCALING_FACTOR, new RadianceReader("SCENE_RADIANCES", 2)),
    RADIANCE04("radiance_4", ProductData.TYPE_INT32, SCENE_RADIANCE_SCALING_FACTOR, new RadianceReader("SCENE_RADIANCES", 3)),
    RADIANCE05("radiance_5", ProductData.TYPE_INT32, SCENE_RADIANCE_SCALING_FACTOR, new RadianceReader("SCENE_RADIANCES", 4)),
